...
DarkFly now is: <a href="https://github.com/T3KN0-67161/DarkFly-Tool">DarkFly-2019.1</a> (generation of DarkFly-tool) Try it.
...
* `pkg install python2`
* `pkg install git`
* `git clone https://github.com/T3KN0-67161/DarkFly-Tool`
* `cd DarkFly-Tool`
* `python2 install.py`
...
# support me
<a href="https://www.youtube.com/channel/UCW1CH7406wYlI43i3JTYBCA"><img src="https://img.shields.io/badge/subcribe-YouTube-red.svg">
